  ...
  <fieldset>
    ...
    <div class="page-content">
      <div class="wrapper" data-controller="components--darkmode-debugger">
        ...
        <p>본 약관은 회원(본 약관에 동의한 자를 말합니다. 이하 “회원”이라고 합니다)이 주식회사 배추마켓(이하 “회사”라고 합니다)가 제공하는 위치기반서비스(이하 “서비스”라고 합니다)를 이용함에 있어 회사와 회원의 권리・의무 및 책임사항을 규정함을 목적으로 합니다.</p>
        ...
        <ol>
          ...
          <li>회사가 이러한 위치정보를 토대로 제공하는 서비스의 종류와 내용은 아래와 같습니다. 다만 회사는 경영상, 사업상 이유 등으로 아래 예시한 서비스 중 일부를 중단 내지 변경할 수 있으며, 이에 대해서는 관련 법령 및 본 약관이 정하는 바에 따라 조치하겠습니다.</li>
          <table>
            <thead>
            <tr>
              <th>서비스명</th>
            ...
            <tr>
              ...
              <td rowspan="4">관련 법령 및 제5항이 정하는 바에 의함</td>
            </tr>
            <tr>
              <td>서비스 이용 편의 제공</td>
              <td>
          ...
          <li>회사는 위치정보의 보호 및 이용 등에 관한 법률 제16조 제2항에 따라 위치정보 수집∙이용∙제공 사실 확인자료를 위치정보시스템에 자동으로 기록, 보존하여, 해당 자료는 6개월 이상 보관합니다.</li>
        ...
        <ol>
          <li><p>회사의 상호, 주소 및 연락처는 아래와 같습니다.</p>
            ...
            <ul>
              <li>상호 : 주식회사 배추마켓</li>
              <li>대표 : 김배추</li>
              <li>주소 : 서울특별시 배추구 무도사30길 10, 404호 (배추서비스)</li>
        ...
        <p>제1조 (시행일) 본 약관은 2023년 05월 15일부터 시행합니다.</p>
